"""
Comparativas extraction pipeline: services/extraccion/robot_comparativas.py
...
from services.extraccion.config import CLIENT, get_output_dir, get_processed_dir, COMPARATIVAS_OUTPUT_BASE, DATA_DIR, get_next_client, generate_with_fallback
from services.extraccion.robot import obtener_cliente, nombre_unico
from services.extraccion.gemini_errors import handle_gemini_errors, GeminiQuotaExceededError, GeminiRateLimitError, GeminiTruncationError
from services.extraccion.persistent_chunking import guardar_chunk
