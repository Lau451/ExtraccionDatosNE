...
from presupuestacion.core.audit import registrar_cambios, registrar_evento_ciclo_vida
from presupuestacion.core.database import get_service_client
from presupuestacion.core.exceptions import NotFoundError
from presupuestacion.pricing import repository as repo
from presupuestacion.pricing.models import (
    DetalleCalculo,
    OrigenCosto,
